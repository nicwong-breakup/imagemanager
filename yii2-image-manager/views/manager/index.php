...
<div id='popup-video'>
	...
	<a class='btn btn-primary popup-close'><?=Yii::t('imagemanager','Close Video');?></a>
...
<div id="module-imagemanager" class="container-fluid <?=$selectType?>" data-viewMode="list">
	<div class="row">
			...
			<div class="image-info hide">
				...
				<!-- <div class="edit-buttons">
					<a class="btn btn-primary btn-block crop-image-item">
						...
						<span class="hidden-xs"><?php //Yii::t('imagemanager','Crop')?></span>
					</a>
				</div> -->
				<div class="details">
				...
				<?php endif; ?>
				<a class="btn btn-primary btn-block preview-video hide"><?=Yii::t('imagemanager','Preview Video');?></a>
				<!-- <a class="btn btn-primary btn-block download" download><?php //Yii::t('imagemanager','Download Video');?></a> -->
			</div>
		</div>  
	</div>
</div>  
